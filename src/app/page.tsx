...
const months: MonthSeries[] = [
  {
    ...
    label: "February 2026",
    daily: [
      { label: "2 Feb", gemini: 1, chatgpt: 2, perplexity: 1, copilot: 1, grok: 0 },
      { label: "6 Feb", gemini: 2, chatgpt: 3, perplexity: 1, copilot: 1, grok: 0 },
      { label: "10 Feb", gemini: 2, chatgpt: 2, perplexity: 1, copilot: 1, grok: 0 },
      { label: "14 Feb", gemini: 3, chatgpt: 4, perplexity: 2, copilot: 1, grok: 1 },
      { label: "18 Feb", gemini: 2, chatgpt: 3, perplexity: 2, copilot: 1, grok: 1 },
      { label: "22 Feb", gemini: 4, chatgpt: 4, perplexity: 2, copilot: 2, grok: 1 },
      { label: "26 Feb", gemini: 3, chatgpt: 5, perplexity: 2, copilot: 2, grok: 1 },
      { label: "28 Feb", gemini: 4, chatgpt: 5, perplexity: 3, copilot: 2, grok: 1 },
    ],
    weekly: [
      { label: "Week 1", gemini: 2, chatgpt: 3, perplexity: 1, copilot: 1, grok: 0 },
      { label: "Week 2", gemini: 3, chatgpt: 4, perplexity: 2, copilot: 1, grok: 1 },
      { label: "Week 3", gemini: 2, chatgpt: 4, perplexity: 2, copilot: 2, grok: 1 },
      { label: "Week 4", gemini: 4, chatgpt: 5, perplexity: 3, copilot: 2, grok: 1 },
    ],
  },
  {
    key: "mar",
    label: "March 2026",
    daily: [
      { label: "3 Mar", gemini: 1, chatgpt: 2, perplexity: 1, copilot: 1, grok: 0 },
      { label: "7 Mar", gemini: 2, chatgpt: 2, perplexity: 1, copilot: 1, grok: 0 },
      { label: "11 Mar", gemini: 3, chatgpt: 3, perplexity: 1, copilot: 1, grok: 1 },
      { label: "15 Mar", gemini: 2, chatgpt: 4, perplexity: 2, copilot: 1, grok: 1 },
      { label: "19 Mar", gemini: 4, chatgpt: 3, perplexity: 2, copilot: 2, grok: 1 },
      { label: "23 Mar", gemini: 3, chatgpt: 5, perplexity: 2, copilot: 2, grok: 1 },
      { label: "27 Mar", gemini: 4, chatgpt: 4, perplexity: 3, copilot: 2, grok: 1 },
      { label: "31 Mar", gemini: 5, chatgpt: 5, perplexity: 3, copilot: 2, grok: 2 },
    ],
    weekly: [
      { label: "Week 1", gemini: 2, chatgpt: 2, perplexity: 1, copilot: 1, grok: 0 },
      { label: "Week 2", gemini: 3, chatgpt: 4, perplexity: 2, copilot: 1, grok: 1 },
      { label: "Week 3", gemini: 4, chatgpt: 3, perplexity: 2, copilot: 2, grok: 1 },
      { label: "Week 4", gemini: 5, chatgpt: 5, perplexity: 3, copilot: 2, grok: 2 },
    ],
  },
  {
    key: "apr",
    label: "April 2026",
    daily: [
      { label: "23 Apr", gemini: 0, chatgpt: 2, perplexity: 1, copilot: 1, grok: 0 },
      { label: "24 Apr", gemini: 1, chatgpt: 3, perplexity: 1, copilot: 1, grok: 0 },
      { label: "25 Apr", gemini: 2, chatgpt: 2, perplexity: 1, copilot: 1, grok: 0 },
      { label: "26 Apr", gemini: 1, chatgpt: 3, perplexity: 2, copilot: 1, grok: 1 },
      { label: "27 Apr", gemini: 2, chatgpt: 3, perplexity: 2, copilot: 2, grok: 1 },
      { label: "28 Apr", gemini: 3, chatgpt: 2, perplexity: 2, copilot: 2, grok: 1 },
      { label: "29 Apr", gemini: 1, chatgpt: 3, perplexity: 3, copilot: 2, grok: 1 },
      { label: "30 Apr", gemini: 3, chatgpt: 3, perplexity: 3, copilot: 2, grok: 1 },
      { label: "1 May", gemini: 3, chatgpt: 5, perplexity: 3, copilot: 2, grok: 2 },
    ],
    weekly: [
      { label: "Week 1", gemini: 1, chatgpt: 3, perplexity: 1, copilot: 1, grok: 0 },
      { label: "Week 2", gemini: 2, chatgpt: 3, perplexity: 2, copilot: 1, grok: 1 },
      { label: "Week 3", gemini: 3, chatgpt: 2, perplexity: 2, copilot: 2, grok: 1 },
      { label: "Week 4", gemini: 3, chatgpt: 5, perplexity: 3, copilot: 2, grok: 2 },
    ],
  },
  {
    key: "may",
    label: "May 2026",
    daily: [
      { label: "4 May", gemini: 2, chatgpt: 3, perplexity: 1, copilot: 1, grok: 1 },
      { label: "8 May", gemini: 3, chatgpt: 2, perplexity: 1, copilot: 1, grok: 1 },
      { label: "12 May", gemini: 4, chatgpt: 4, perplexity: 2, copilot: 1, grok: 1 },
      { label: "16 May", gemini: 3, chatgpt: 4, perplexity: 2, copilot: 2, grok: 1 },
      { label: "20 May", gemini: 5, chatgpt: 3, perplexity: 2, copilot: 2, grok: 2 },
      { label: "24 May", gemini: 4, chatgpt: 5, perplexity: 3, copilot: 2, grok: 2 },
      { label: "28 May", gemini: 5, chatgpt: 4, perplexity: 3, copilot: 3, grok: 2 },
      { label: "31 May", gemini: 6, chatgpt: 5, perplexity: 3, copilot: 3, grok: 2 },
    ],
    weekly: [
      { label: "Week 1", gemini: 3, chatgpt: 3, perplexity: 1, copilot: 1, grok: 1 },
      { label: "Week 2", gemini: 4, chatgpt: 4, perplexity: 2, copilot: 2, grok: 1 },
      { label: "Week 3", gemini: 5, chatgpt: 4, perplexity: 3, copilot: 2, grok: 2 },
      { label: "Week 4", gemini: 6, chatgpt: 5, perplexity: 3, copilot: 3, grok: 2 },
    ],
  },
];
...
const chartSeries: Array<{
  ...
  { key: "gemini", label: "Gemini", color: "var(--accent-blue)", icon: "gemini" },
  { key: "chatgpt", label: "Chat GPT", color: "var(--accent-orange)", icon: "chatgpt" },
  {
    key: "perplexity",
    label: "perplexity",
  ...
  { key: "copilot", label: "Copilot", color: "var(--accent-pink)", icon: "copilot" },
...
function getChartXWithPadding(index: number, total: number, leftPadding: number) {
...
function samplePoint(points: SeriesPoint[], index: number, targetLength: number) {
  if (points.length === 0) {
...
function sampleX(points: Array<{ x: number }>, index: number, targetLength: number) {
  if (points.length === 0) {
...
function applyVariant(points: SeriesPoint[], variant: VariantConfig) {
  ...
  return points.map((point, index) => {
    ...
    modelKeys.forEach((key) => {
      ...
      const wave = Math.sin(progress * Math.PI * 2 + modifier.phase) * modifier.wave;
    ...
    >
      ...
      <span
        className={`relative h-3.5 w-6 rounded-full transition-colors ${
          checked ? "bg-[var(--accent-blue)]" : "bg-[var(--separator-prominent)]"
        }`}
      >
        <span
    ...
    <article className="rounded-xl border border-[var(--separator-light)] bg-[var(--background-card)]">
      ...
      <div className="px-6 pb-6">
        ...
        <div className="mt-1 flex items-center justify-between gap-3">
          <div className="text-[14px] text-[var(--foreground-secondary)]">{meta}</div>
          {children}
        </div>
      </div>
    </article>
...
function ModelIcon({
    ...
    return (
      <svg width={iconSize} height={iconSize} viewBox="0 0 16 16" fill="none" aria-hidden="true">
        <path
          ...
          strokeWidth="1.2"
        />
        <path d="M6.3 8H9.7" stroke={stroke} strokeWidth="1.2" strokeLinecap="round" />
      </svg>
    );
  }
  ...
  return (
    <svg width={iconSize} height={iconSize} viewBox="0 0 16 16" fill="none" aria-hidden="true">
      ...
      <path d="M4.2 11.8L11.8 4.2" stroke={stroke} strokeWidth="1.2" strokeLinecap="round" />
    </svg>
  );
}
...
function Sparkline({
  ...
  return (
    <svg viewBox={`0 0 ${width} ${height}`} className="h-[14px] w-[31px]" aria-hidden="true">
      <path
        d={path}
        fill="none"
        stroke={color}
...
function ArrowIcon({ direction }: { direction: "left" | "right" }) {
  return (
    <svg width="12" height="12" viewBox="0 0 16 16" fill="none" aria-hidden="true">
      <path
        d={direction === "left" ? "M9.5 3.5L5 8L9.5 12.5" : "M6.5 3.5L11 8L6.5 12.5"}
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export default function Home() {
  ...
  const activeVariant =
    chartVariants.find((variant) => variant.key === selectedVariant) ?? chartVariants[0];
  ...
  useEffect(() => {
    ...
    const animate = (now: number) => {
      ...
      const nextPoints = targetPoints.map((targetPoint, index) => {
        const sourcePoint = samplePoint(startPoints, index, targetPoints.length);
        ...
        return {
          ...
          gemini:
            sourcePoint.gemini + (targetPoint.gemini - sourcePoint.gemini) * eased,
          chatgpt:
            sourcePoint.chatgpt +
          ...
          copilot:
            sourcePoint.copilot + (targetPoint.copilot - sourcePoint.copilot) * eased,
          grok: sourcePoint.grok + (targetPoint.grok - sourcePoint.grok) * eased,
        };
      });
  ...
  const metricRows: MetricRow[] = chartSeries.map((series) => {
    const sparkline = displayPoints.map((point) => Number(point[series.key].toFixed(2)));
  ...
  const tooltipY =
    hoveredPoint === null
      ...
      : Math.max(
          ...
          Math.min(
            76,
            Math.min(...hoveredValues.map((entry) => getChartY(entry.value))) - 44,
          ),
        );
  ...
  const useNothingSkin = selectedVariant === "type-10";
      ...
      <div className="mx-auto flex w-full max-w-[1512px] flex-col gap-6 px-6 py-6">
        <section className="grid gap-[18px] lg:grid-cols-3">
          ...
          <SummaryCard
            ...
            meta={<span className="text-[12px] text-[var(--status-success)]">+20.1% from last week</span>}
          />
        </section>
        ...
        <section className="grid gap-6 xl:grid-cols-[340px_minmax(0,1fr)]">
          <aside className="rounded-lg border border-[var(--separator-light)] bg-[var(--background-card)] p-[18px]">
            <div className="flex items-center justify-between">
              ...
              <TinySelect value="today" options={[{ value: "today", label: "Today" }]} />
            </div>
            ...
            <div className="mt-4">
              ...
              <div className="mt-6 space-y-4">
                {modelRows.map((model) => (
                  <div key={model.name} className="grid grid-cols-[28px_minmax(0,1fr)] gap-3">
                    ...
                    <div>
                      ...
                      <div className="mt-[6px]">
                        <SegmentedBar value={model.shareValue} color={model.color} />
                      </div>
                    </div>
                  </div>
                ))}
          ...
          <section className="rounded-lg border border-[var(--separator-light)] bg-[var(--background-card)] p-[18px]">
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-1">
                ...
                <button
                  ...
                  onClick={() => setMonthIndex((index) => (index - 1 + months.length) % months.length)}
                ...
                <button
                  ...
                  onClick={() => setMonthIndex((index) => (index + 1) % months.length)}
                  className="flex h-7 w-7 items-center justify-center rounded-lg bg-[var(--background-prominent)] text-[var(--foreground-tertiary)]"
                >
            ...
            <div className="relative mt-[19px] overflow-x-auto">
              {hoveredPoint !== null && hoveredX !== null && tooltipY !== null ? (
                <div
                        ...
                        style={{
                          background:
                            hoveredSeries === entry.key
                              ...
                              : "transparent",
                          opacity:
                            hoveredSeries === null || hoveredSeries === entry.key
                              ? 1
                              : 0.7,
                        }}
                      >
              ...
              >
                <defs>
                  ...
                  {useNothingSkin ? (
                    ...
                    >
                      <circle cx="1.8" cy="1.8" r="1.15" fill="var(--separator-light)" opacity="0.8" />
                    </pattern>
                  ) : null}
                </defs>
                {useTypeSevenSkin ? (
                ...
                {Array.from({ length: chartMaxValue + 1 }).map((_, index) => {
                  ...
                  const y = chartPadding.top + (index * innerHeight) / chartMaxValue;
                  ...
                  return (
                    <g key={value}>
                      <line
                        ...
                        strokeDasharray={useTypeSevenSkin ? "3 8" : useNothingSkin ? "2 10" : undefined}
                        opacity={useNothingSkin ? 0.55 : 1}
                      />
                      {axisVisible ? (
                        <text
                          x="0"
                          ...
                          fontSize="12"
                          fontFamily={useNothingSkin ? "var(--font-geist-mono)" : undefined}
                          letterSpacing={useNothingSkin ? "0.08em" : undefined}
                          opacity="0.7"
                        >
                          {value}
                        </text>
                ...
                {useNothingSkin
                  ? displayPoints.map((point) => (
                      <line
                        key={`nothing-vertical-grid-${point.label}`}
                        x1={point.x}
                        y1={chartPadding.top}
                        x2={point.x}
                        y2={chartHeight - 28}
                ...
                {hoveredSeries !== null && (!useTypeSevenSkin || useHoverOnlyTypeEightArea)
                  ? seriesPaths
                ...
                {seriesPaths.map((series) => (
                  <path
                    key={series.key}
                    d={useCurvedLines ? buildSmoothLinePath(series.points) : buildLinePath(series.points)}
                    fill="none"
                    stroke={series.color}
                    strokeWidth={
                      useTypeSevenSkin
                    ...
                    opacity={
                      hoveredSeries === null
                        ? useTypeSevenSkin || useNothingSkin
                          ? 0.98
                          : series.key === "gemini" || series.key === "chatgpt"
                            ? 1
                            : 0.9
                  ...
                  ? chartSeries.flatMap((series) =>
                      displayPoints.map((point, index) => (
                        <circle
                          ...
                          r={hoveredSeries === series.key && hoveredIndex === index ? "3.8" : "2.6"}
                          fill={series.color}
                  ...
                  return (
                    <g key={point.label}>
                      <text
                        ...
                        fontFamily={useNothingSkin ? "var(--font-geist-mono)" : undefined}
                        letterSpacing={useNothingSkin ? "0.06em" : undefined}
                        opacity="0.7"
                      >
                        {point.label}
                      </text>
              ...
              <div className="space-y-0">
                {metricRows.map((row, index) => (
                  <div
                    ...
                    style={{
                      background:
                        index % 2 === 0 ? "var(--background-primary)" : "transparent",
                    }}
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[14px] text-[var(--foreground-primary)]">{row.name}</span>
                    </div>
                    <div className="flex items-center justify-end gap-[10px] rounded border border-[var(--separator-button)] bg-[var(--background-secondary)] px-3 py-[3px]">
                      <span className="text-[14px] text-[var(--foreground-secondary)]">{row.metric}</span>
                      <Sparkline
